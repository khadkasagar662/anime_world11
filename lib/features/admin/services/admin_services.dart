...
import 'package:assignmentfinal/features/admin/model/sales.dart';
...
class AdminServices {
  void sellProduct({
    ...
    try {
      ...
      final cloudinary = CloudinaryPublic('djzvs8os1', 'gqa213or');
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            ...
            Sales('Apparel', response['apparelEarnings']),
            Sales('Wallet', response['walletEarnings']),
          ];
        },
      );
    } catch (e) {
